...
python3 utils.py --mode 0 --dataset ${CORPUS_DIR} --in_file ${CORPUS_FILE} --out_file ./AutoPhrase/data/text.txt
...
cd ..
python3 utils.py --mode 1 --dataset NEW --out_file ${CORPUS_DIR}/phrase_text.txt
